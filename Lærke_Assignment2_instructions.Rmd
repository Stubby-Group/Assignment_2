...
pp_check(ai_m1_priors, nsamples = 100)# Shows us how the predictions of the model are going to spread out compared to the actual data
plot(conditional_effects(ai_m1_priors), spaghetti = T, 
     method = "predict", 
     nsamples = 100, 
