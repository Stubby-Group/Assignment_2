...
```{r}
# Loading packages:
pacman::p_load(tidyverse, rethinking, brms, bayesplot, viridis)
...
# Now also including a prior for beta
prior <- c(
  prior(normal(0, 1), class = Intercept),
  prior(normal(0, 0.5), class = Intercept), # "a prior for the relation between feedback and change" what should i set the second number to? (lecture: 1:22:00) I don't understand his reasons for choosing 0.5
  prior(normal(1, 0.5), class = sigma),
