...
ai_f1 <- bf(AltercentricIntrusion ~ 1 + Diagnosis + 
              (1 + AltercentricIntrusion | ID))  #0+ or 1+?????
...
# Riccardo: It approcimates the data okay, but given that it hasn't seen the data, and we have three levels of uncertainty (eh? intercept, sd that [eac] random effect has from that, and the sigma, [it goes all the way to -20 and +20]), 
