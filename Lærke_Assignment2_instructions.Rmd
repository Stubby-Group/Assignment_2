...
# How do we know if we want to change our priors based on the prior predictive check? Was it even a prior predictive chect that I made?
```


```{r First look + standardization}
# Plotting
...
```{r 1) Posterior predictive check}
