...
```{r_1.1) First look + standardization}
# Plotting
...
```{r_1.1.1) define model and priors}
...
```{r_1.1.2) prior predictive check}
#What is this?
ai_m1_prior <- brm(
  ai_f1,
  dstand,
...
```{r_1.1.4) Posterior predictive check}
