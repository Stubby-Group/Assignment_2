...
#Priors
get_prior(m1, dstand, family = gaussian) #We need a prior for the intercept, a prior for the sigma, and a prior for the sd:
prior1 <- c(
...
pp_check (lrl_m_priorCheck, nsamples= 100)
```
